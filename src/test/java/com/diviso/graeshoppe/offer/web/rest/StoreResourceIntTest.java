...
public class StoreResourceIntTest {
     ...
     *
     * @see com.diviso.graeshoppe.offer.repository.search.StoreSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void createStore() throws Exception {
        ...
        assertThat(testStore.getOutletId()).isEqualTo(DEFAULT_OUTLET_ID);
    ...
    public void updateStore() throws Exception {
        ...
        assertThat(testStore.getOutletId()).isEqualTo(UPDATED_OUTLET_ID);
