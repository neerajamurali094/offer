...
import { CustomerSelectionComponent } from 'app/entities/Offer/customer-selection/customer-selection.component';
...
describe('Component Tests', () => {
  describe('CustomerSelection Management Component', () => {
    let comp: CustomerSelectionComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(CustomerSelectionComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      spyOn(service, 'query').and.returnValue(
        of(
          new HttpResponse({
            body: [new CustomerSelection(123)],
            headers
          })
        )
      );
      ...
      expect(comp.customerSelections[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
