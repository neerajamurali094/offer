...
import { PaymentRuleComponent } from 'app/entities/Offer/payment-rule/payment-rule.component';
...
describe('Component Tests', () => {
  describe('PaymentRule Management Component', () => {
    let comp: PaymentRuleComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(PaymentRuleComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.paymentRules[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
